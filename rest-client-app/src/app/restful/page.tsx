    ...
    return (
      <section className="max-w-4xl mx-auto p-6">
        ...
        <fieldset className="border-2 border-gray-300 rounded-md p-4 bg-gray-50">
            ...
            <div className="mb-4">
            <label htmlFor="response-status" className="block text-sm font-medium text-gray-700 mb-1">
              Status Code
            </label>
            <input
              id="response-status"
            ...
            />
            <div className="mb-2">
            <label htmlFor="response-body" className="block text-sm font-medium text-gray-700 mb-1">
              Response Body
            </label>
            <textarea
              id="response-body"
